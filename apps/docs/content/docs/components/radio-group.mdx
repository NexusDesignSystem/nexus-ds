...
<ImportTabs
  commands={{
    main: 'import {RadioGroup, Radio} from "@nexus-ds/react";',
    individual: 'import {RadioGroup, Radio} from "@nexus-ds/radio";',
  }}
/>
...
> **Note**: Nexus Design System `Radio` also supports native events like `onChange`, useful for form libraries
