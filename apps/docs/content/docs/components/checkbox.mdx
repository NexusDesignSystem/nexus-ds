...
<ImportTabs
  commands={{
    main: 'import {Checkbox} from "@nexus-ds/react";',
    individual: 'import {Checkbox} from "@nexus-ds/checkbox";',
  }}
/>
...
> **Note**: Nexus Design System `Checkbox` also supports native events like `onChange`, useful for form libraries
