...
Nexus Design System exports 2 accordion-related components:
...
<ImportTabs
  commands={{
    main: 'import {Accordion, AccordionItem} from "@nexus-ds/react";',
    individual: 'import {Accordion, AccordionItem} from "@nexus-ds/accordion";',
  }}
/>
