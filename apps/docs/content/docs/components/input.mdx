...
<ImportTabs
  commands={{
    main: 'import {Input} from "@nexus-ds/react";',
    individual: 'import {Input} from "@nexus-ds/input";',
  }}
/>
...
> **Note**: Nexus Design System `Input` also supports native events like `onChange`, useful for form libraries
