...
Nexus Design System exports 2 checkbox-related components:
...
<ImportTabs
  commands={{
    main: 'import {CheckboxGroup, Checkbox} from "@nexus-ds/react";',
    individual: 'import {CheckboxGroup, Checkbox} from "@nexus-ds/checkbox";',
  }}
/>
