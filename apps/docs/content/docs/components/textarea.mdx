...
<ImportTabs
  commands={{
    main: 'import {Textarea} from "@nexus-ds/react";',
    individual: 'import {Textarea} from "@nexus-ds/input";',
  }}
/>
...
> **Note**: Nexus Design System `Textarea` also supports native events like `onChange`, useful for form libraries
