...
Nexus Design System exports 3 select-related components:
...
<ImportTabs
  commands={{
    main: 'import {Select, SelectSection, SelectItem} from "@nexus-ds/react";',
    individual: 'import {Select, SelectSection, SelectItem} from "@nexus-ds/select";',
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @nexus-ds/use-infinite-scroll",
    yarn: "yarn add @nexus-ds/use-infinite-scroll",
    pnpm: "pnpm add @nexus-ds/use-infinite-scroll",
  }}
/>
