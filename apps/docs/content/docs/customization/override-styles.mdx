...
description: Nexus Design System allows you to override the default styles of the components in several ways.
---
...
Some Nexus Design System components have slots, which means that you can style all the parts inside the component
...
```jsx {9-12}
import {CircularProgress, Card, CardBody} from "@nexus-ds/react";
