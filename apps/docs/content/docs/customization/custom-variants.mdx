...
description: Learn how to create new variants for the Nexus Design System components.
---

# Custom Variants

Nexus Design System allows you to create new variants for components that better suit your project's needs.
...
reference. Go [here](https://github.com/NexusDesignSystem/nexus-ds/blob/feat/v2/packages/core/theme/src/components/button.ts) to view the styles source code.
...
```tsx
// MyButton.tsx
import {extendVariants, Button} from "@nexus-ds/react";
...
reference. Go [here](https://github.com/NexusDesignSystem/nexus-ds/blob/feat/v2/packages/core/theme/src/components/input.ts) to view the styles source code.
...
```tsx
// MyInput.tsx
import {extendVariants, Input} from "@nexus-ds/react";
...
<Blockquote>
  All Nexus Design System components have the `Styles source` link on top of the page. This link will take you to
...
/**
 * BaseComponent -> Nexus Design System component to extend
