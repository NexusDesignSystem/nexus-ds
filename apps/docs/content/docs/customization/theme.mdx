---
title: Theme
description: Learn how to customize your application's appearance using Nexus Design System's TailwindCSS plugin.
---
...
In Nexus Design System, we facilitate easy and flexible theme customization using a
...
A theme, in the context of Nexus Design System, is a predefined set of colors, layout attributes, and other
...
The first step to using Nexus Design System's theming capability is adding the `nexusui` plugin to your
...
The `nexusui` plugin provides a default structure. It is outlined as follows:

```js
module.exports = {
  plugins: [
    nexusui({
      prefix: "nexusui", // prefix for themes variables
...
Nexus Design System supports nested themes, allowing you to apply different themes to different sections
of your application:
...
Nexus Design System enables you to apply TailwindCSS styles based on the currently active theme. Below are
...
with themes in nexus:

| Attribute          | Type                          | Description                                                                                                     | Default  |
| ------------------ | ----------------------------- | --------------------------------------------------------------------------------------------------------------- | -------- |
| prefix             | `string`                      | The prefix for the css variables.                                                                               | `nexusui` |
| addCommonColors    | `boolean`                     | If true, the common nexusui colors (e.g. "blue", "green", "purple") will replace the TailwindCSS default colors. | `false`  |
