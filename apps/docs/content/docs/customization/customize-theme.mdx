...
description: Learn how Nexus Design System enables effortless customization of default themes.
---

# Customize theme

As outlined in preceding sections, Nexus Design System presents two predefined themes, `light` and `dark`. 
...
As Nexus Design System components employ layout tokens, the modifications will be reflected across all 
